# คู่มือการติดตั้งระบบจัดซื้อวัสดุพัสดุ (Production Installation & Deployment Guide v1.29)
...
* **Database Server (MySQL 8.0+):** ติดตั้งบน IP **`10.1.0.201`** พอร์ต `3306` (ชื่อฐานข้อมูล: `MatPlan`)
...
-- 2. สร้างตารางสำหรับเก็บข้อมูลสถานะของระบบ (ระบบจะสร้างตาราง Relational อื่นๆ ทั้ง 10 ตารางให้อัตโนมัติเมื่อเริ่มแอปครั้งแรก)
USE MatPlan;
...
- **สถาปัตยกรรมตัดยอดเบิกจ่ายพัสดุ (Disbursement Quota Adapter):** ออกแบบระบบรองรับการเชื่อมต่อข้อมูลตัดยอดการเบิกจ่ายจริงจากระบบภายนอก (Excel Import, REST API) พร้อมระบบคำนวณโควตาคงเหลือและ Audit Log
